"""Custom action decorator for FastAPI routers.
...
def action(
    ...
    url_path: str | None = None,
    dependencies: list[Callable[..., Any]] | None = None,
    response_model: type[BaseModel] | type | None = None,
    response_model_by_alias: bool = True,
    status_code: int | None = None,
    summary: str | None = None,
    description: str | None = None,
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        class AgentRouter(BaseRouter):
            ...
            async def activate_agent(self, agent_id: str, session: AsyncSession):
                # Activate agent logic
                pass

            @action(method="GET", detail=False, url_path="active")
            async def get_active_agents(self, session: AsyncSession):
                # Get active agents
                pass
        ```
    """
