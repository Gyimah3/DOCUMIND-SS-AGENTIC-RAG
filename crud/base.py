...
class BaseCRUD(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def detect_changes(
        ...
        Args:
            ...
            new_obj: The updated object state
            fields_to_track: List of field names to check for changes

        Returns:
            Dictionary with field changes in format {"field": {"old": value, "new": value}}
    ...
    async def log_update_changes(
        ...
        """Log changes made during an update operation.
        ...
        """
        changes = self.detect_changes(old_obj, new_obj, fields_to_track)
        if changes:
